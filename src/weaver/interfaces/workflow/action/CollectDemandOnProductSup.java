...
public class CollectDemandOnProductSup extends BaseBean implements Action {
    /**
...
//                "END;";
        ...
        {
            writeLog("销售计划填报流程正常-Sup节点 requestid:"+requestId);
            //writeLog(SQL);
        }
        else
        {
            writeLog("销售计划填报流程出错-Sup节点 requestid:"+requestId);
        }
